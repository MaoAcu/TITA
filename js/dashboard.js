// ===== CONFIGURACIÓN INICIAL =====
        ...
        function setupDeleteButton() {
            ...
            if (confirmDeleteBtn) {
                ...
                // Obtener la nueva referencia después del clone
                const newConfirmBtn = document.getElementById('confirmDeleteBtn');
        
                newConfirmBtn.addEventListener('click', function() {
                    if (deleteCallback) {
                    // Ejecutar la función de callback que elimina el elemento
                    deleteCallback();
        ...
        function saveCategoria(e) {
            ...
            if (currentSection === 'categorias') {
                // Si estamos en la sección de categorías, actualizar la vista
